        ...
        try {
            ...
            friendships.forEach(friendship -> {
                if (!Objects.equals(friendship.getUser1().getEmail(), userEmail)) {
                    System.out.println(friendship.getUser1().getFirstName() + " | " + friendship.getUser1().getLastName() + " | " + friendship.getDate());
                }
                if (!Objects.equals(friendship.getUser2().getEmail(), userEmail)) {
                    System.out.println(friendship.getUser2().getFirstName() + " | " + friendship.getUser2().getLastName() + " | " + friendship.getDate());
                }
            });
        }catch (Exception e) {
            System.out.println(e.getMessage());
